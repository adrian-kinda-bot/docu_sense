module Users
  module Models
    class Customer < ApplicationRecord
      ...
      has_many :subscriptions, class_name: Subscriptions::Models::Subscription.name, dependent: :destroy
      has_many :documents, through: :document_collections, class_name: Documents::Models::Document.name
